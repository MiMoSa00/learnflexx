  ...
  return (
    <section className="relative min-h-screen flex items-center pt-20 sm:pt-24 pb-12 sm:pb-16 overflow-hidden">
      ...
      <div className="absolute inset-0 -z-10">
        ...
        {/* Floating shapes */}
        <div className="absolute top-20 left-10 w-48 h-48 sm:w-72 sm:h-72 bg-primary/10 rounded-full blur-3xl animate-float" />
        <div className="absolute bottom-20 right-10 w-64 h-64 sm:w-96 sm:h-96 bg-accent/10 rounded-full blur-3xl animate-float" style={{ animationDelay: "1s" }} />
        <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-64 h-64 sm:w-96 sm:h-96 bg-primary/5 rounded-full blur-3xl animate-pulse" />
            ...
            <ScrollReveal direction="up" delay={300}>
              <div className="relative mb-4 sm:mb-6 w-full">
                ...
                >
                  ...
                  <Link href={`/courses?q=${searchQuery}`}>
                    <BouncyButton
                      variant="primary"
                      size="md"
                      className="mr-1.5 sm:mr-2 text-xs sm:text-sm px-3 sm:px-4 py-2 sm:py-2.5"
                    >
                      Search
                    </BouncyButton>
                  </Link>
                ...
                {isFocused && showSuggestions && (
                  <div className="absolute top-full left-0 right-0 sm:right-auto mt-2 bg-card border-2 border-primary rounded-xl shadow-2xl p-3 sm:p-4 animate-slide-up z-50 sm:w-96">
                    <div className="flex items-center justify-between mb-2 sm:mb-3">
                      <p className="text-xs sm:text-sm font-semibold text-muted-foreground">Popular searches:</p>
                      <button
                    ...
                    <div className="flex flex-wrap gap-1.5 sm:gap-2">
                      {searchSuggestions.map((suggestion) => (
                        <button
                          ...
                          className="px-2.5 sm:px-3 py-1 sm:py-1.5 text-xs sm:text-sm bg-muted rounded-lg hover:bg-primary hover:text-primary-foreground transition-all duration-200 hover:scale-105 whitespace-nowrap"
                        >
                          {suggestion}
                        </button>
                      ))}
            ...
            <ScrollReveal direction="up" delay={400}>
              <div className="flex flex-col sm:flex-row flex-wrap items-stretch sm:items-center gap-2 sm:gap-3 md:gap-4">
                <Link href="/courses" className="w-full sm:w-auto">
                  <BouncyButton variant="primary" size="lg" className="gap-2 w-full sm:w-auto text-sm sm:text-base">
                    Browse Courses
                ...
                <Link href="/how-it-works" className="w-full sm:w-auto">
                  <Button 
                    variant="outline" 
                    size="lg" 
                    className="gap-2 btn-bouncy border-2 bg-transparent w-full sm:w-auto text-sm sm:text-base"
                  >
                ...
                <div className="flex items-center gap-2">
                  <div className="flex -space-x-2">
                    {[1, 2, 3, 4].map((i) => (
                      <div
                        key={i}
                        className="w-6 h-6 sm:w-8 sm:h-8 rounded-full bg-gradient-to-br from-primary to-accent border-2 border-background"
                      />
                    ))}
                  </div>
          ...
          <div className="hidden lg:block relative">
            <ScrollReveal direction="right" delay={200}>
              <div className="relative">
                {/* Main Card */}
                <div className="relative bg-card rounded-3xl p-6 lg:p-8 shadow-2xl border border-border animate-float">
                  <div className="w-full aspect-square bg-gradient-to-br from-primary/20 to-accent/20 rounded-2xl flex items-center justify-center">
                    <div className="text-center">
                      <div className="w-20 h-20 lg:w-24 lg:h-24 mx-auto mb-4 rounded-2xl bg-primary flex items-center justify-center animate-bounce-rotate">
                        <svg className="w-10 h-10 lg:w-12 lg:h-12 text-primary-foreground" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                          <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M12 6.253v13m0-13C10.832 5.477 9.246 5 7.5 5S4.168 5.477 3 6.253v13C4.168 18.477 5.754 18 7.5 18s3.332.477 4.5 1.253m0-13C13.168 5.477 14.754 5 16.5 5c1.747 0 3.332.477 4.5 1.253v13C19.832 18.477 18.247 18 16.5 18c-1.746 0-3.332.477-4.5 1.253" />
                        </svg>
                      </div>
                      <p className="text-base lg:text-lg font-semibold text-foreground">Start Learning Today</p>
                ...
                {/* Floating Elements */}
                <div className="absolute -top-6 -right-6 bg-accent text-accent-foreground px-3 lg:px-4 py-1.5 lg:py-2 rounded-xl shadow-lg animate-float text-sm" style={{ animationDelay: "0.5s" }}>
                  <p className="font-semibold">Flexible Payments</p>
                </div>

                <div className="absolute -bottom-4 -left-4 bg-card border border-border px-3 lg:px-4 py-2 lg:py-3 rounded-xl shadow-lg animate-float" style={{ animationDelay: "1s" }}>
                ...
                <div className="absolute top-1/2 -right-8 bg-primary text-primary-foreground px-3 lg:px-4 py-1.5 lg:py-2 rounded-xl shadow-lg animate-float text-sm" style={{ animationDelay: "1.5s" }}>
