    ...
    <>
      ...
      <aside
        className={cn(
          ...
          "top-[80px]", // Stick 80px from top (below header)
          "self-start", // Align to start of container
          "h-[calc(100vh-100px)]", // Height stops before footer area
          ...
          <div className="space-y-1">
            {session ? (
              ...
              <>
                ...
                {/* Divider */}
                <div className="my-3 border-t border-border dark:border-gray-700" />
                
                {/* Public pages when logged in */}
              ...
              // Show Home + Public pages when NOT logged in
              <>
                <Link
                  href="/"
                  onClick={handleLinkClick}
