...
const categoryInfo = {
  ...
  slug: "vocational",
  description: "Hands-on skills training in trade, crafts, and technical professions",
  icon: Wrench,
  color: "from-orange-500 to-amber-600",
}

const subCategories = [
  { name: "Electrical", icon: Zap, count: 18 },
  { name: "Plumbing", icon: Layers, count: 14 },
  { name: "Automotive", icon: Car, count: 12 },
  { name: "HVAC", icon: Settings, count: 8 },
  { name: "Construction", icon: Hammer, count: 16 },
  { name: "Fashion & Tailoring", icon: Shirt, count: 20 },
]

const courses = [
  { id: 10, title: "Certified Electrical Installation", provider: "Trade Skills Academy", price: 120000, rating: 4.8, students: 890, duration: "10 weeks", type: "In-person" },
  { id: 11, title: "Automotive Mechanics Masterclass", provider: "AutoTech Institute", price: 180000, rating: 4.9, students: 750, duration: "16 weeks", type: "Hybrid" },
  { id: 12, title: "Plumbing & Pipe Fitting", provider: "BuildRight Training", price: 95000, rating: 4.7, students: 620, duration: "8 weeks", type: "In-person" },
  { id: 13, title: "Fashion Design & Tailoring", provider: "Style Academy NG", price: 150000, rating: 4.9, students: 1100, duration: "12 weeks", type: "Hybrid" },
  { id: 14, title: "HVAC Installation & Repair", provider: "CoolTech Academy", price: 140000, rating: 4.6, students: 480, duration: "10 weeks", type: "In-person" },
  { id: 15, title: "Welding & Fabrication", provider: "MetalWorks Institute", price: 110000, rating: 4.8, students: 560, duration: "8 weeks", type: "In-person" },
]
...
function VocationalContent() {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-orange-50 via-white to-amber-50 dark:from-gray-900 dark:via-gray-800 dark:to-gray-900 overflow-x-hidden">
      {/* Hero Section */}
        ...
        <div className="max-w-6xl mx-auto">
          ...
          <ScrollReveal direction="up" delay={50}>
            <div className="flex flex-col sm:flex-row gap-3 sm:gap-4 mb-6 sm:mb-8">
              <div className="relative flex-1">
                ...
                <input
                  type="text"
                  placeholder="Search vocational courses..."
                  value={searchQuery}
                  onChange={(e) => setSearchQuery(e.target.value)}
                  className="w-full pl-10 sm:pl-12 pr-4 py-2.5 sm:py-3 rounded-xl border border-input bg-white dark:bg-gray-800 text-foreground shadow-lg focus:ring-2 focus:ring-orange-500 focus:outline-none text-sm sm:text-base"
                />
              </div>
          ...
          <ScrollReveal direction="up" delay={100}>
            <p className="text-sm sm:text-base text-muted-foreground mb-4 sm:mb-6">
              Showing {sortedCourses.length} courses in Vocational Training
            </p>
          </ScrollReveal>
                  ...
                  <Card className="h-full border-0 shadow-lg hover:shadow-xl transition-all hover:-translate-y-2 bg-white/80 dark:bg-gray-800/80 backdrop-blur-sm overflow-hidden group">
                    ...
                    <div className="p-4 sm:p-5">
                      ...
                      <div className="flex items-center justify-between">
                        <div>
                          <p className="text-base sm:text-lg font-bold text-orange-600">{formatCurrency(course.price)}</p>
                          <p className="text-xs text-muted-foreground">or installments</p>
                        </div>
                        <span className="text-xs px-2 py-1 rounded-full bg-orange-100 dark:bg-orange-900/30 text-orange-600">
                          {course.type}
                        </span>
                      </div>
                    </div>
          ...
          <ScrollReveal direction="up" delay={200}>
            <div className="mt-8 sm:mt-12 text-center">
              ...
              <Link href="/courses">
                <BouncyButton variant="primary" className="bg-orange-600 hover:bg-orange-700">
                  Browse All Courses
