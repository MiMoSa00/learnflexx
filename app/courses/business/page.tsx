...
const categoryInfo = {
  ...
  slug: "business",
  description: "Start, grow, and scale your business with practical entrepreneurial skills",
  icon: LineChart,
  color: "from-emerald-500 to-teal-600",
}

const subCategories = [
  { name: "Startup Basics", icon: Building2, count: 18 },
  { name: "Marketing", icon: Megaphone, count: 24 },
  { name: "Finance", icon: Wallet, count: 16 },
  { name: "E-commerce", icon: ShoppingBag, count: 14 },
  { name: "Sales", icon: TrendingUp, count: 12 },
  { name: "Investment", icon: DollarSign, count: 10 },
]

const courses = [
  { id: 40, title: "Start Your Business: Complete Guide", provider: "Entrepreneur Hub NG", price: 150000, rating: 4.9, students: 2100, duration: "12 weeks", type: "Hybrid" },
  { id: 41, title: "Digital Marketing Masterclass", provider: "MarketPro Academy", price: 130000, rating: 4.8, students: 1850, duration: "10 weeks", type: "Online" },
  { id: 42, title: "Financial Management for SMEs", provider: "Finance Academy NG", price: 180000, rating: 4.9, students: 920, duration: "14 weeks", type: "Hybrid" },
  { id: 43, title: "E-commerce Business Setup", provider: "Digital Commerce NG", price: 110000, rating: 4.7, students: 1200, duration: "8 weeks", type: "Online" },
  { id: 44, title: "Sales & Negotiation Skills", provider: "SalesForce Academy", price: 95000, rating: 4.8, students: 780, duration: "6 weeks", type: "Online" },
  { id: 45, title: "Investment & Wealth Building", provider: "Invest Smart NG", price: 220000, rating: 4.9, students: 650, duration: "16 weeks", type: "Hybrid" },
]
...
function BusinessContent() {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-emerald-50 via-white to-teal-50 dark:from-gray-900 dark:via-gray-800 dark:to-gray-900 overflow-x-hidden">
      {/* Hero Section */}
        ...
        <div className="max-w-6xl mx-auto">
            ...
            <div className="flex flex-col sm:flex-row gap-3 sm:gap-4 mb-6 sm:mb-8">
              <div className="relative flex-1">
                ...
                <input
                  ...
                  className="w-full pl-10 sm:pl-12 pr-4 py-2.5 sm:py-3 rounded-xl border border-input bg-white dark:bg-gray-800 text-foreground shadow-lg focus:ring-2 focus:ring-emerald-500 focus:outline-none text-sm sm:text-base"
                />
              </div>
          ...
          <ScrollReveal direction="up" delay={100}>
            <p className="text-sm sm:text-base text-muted-foreground mb-4 sm:mb-6">
              Showing {sortedCourses.length} courses in Business & Entrepreneurship
            </p>
          </ScrollReveal>
                  ...
                  <Card className="h-full border-0 shadow-lg hover:shadow-xl transition-all hover:-translate-y-2 bg-white/80 dark:bg-gray-800/80 backdrop-blur-sm overflow-hidden group">
                    ...
                    <div className="p-4 sm:p-5">
                      ...
                      <div className="flex items-center justify-between">
                        <div>
                          <p className="text-base sm:text-lg font-bold text-emerald-600">{formatCurrency(course.price)}</p>
          ...
          <ScrollReveal direction="up" delay={200}>
            <div className="mt-8 sm:mt-12 text-center">
              ...
              <Link href="/courses">
                <BouncyButton variant="primary" className="bg-emerald-600 hover:bg-emerald-700">
                  Browse All Courses
