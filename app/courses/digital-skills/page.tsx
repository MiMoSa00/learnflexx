...
const categoryInfo = {
  name: "Digital Skills",
  slug: "digital-skills",
  description: "Master coding, web development, data science, and emerging technologies",
  icon: Code,
...
const subCategories = [
  { name: "Web Development", icon: Globe, count: 24 },
  ...
  { name: "Cybersecurity", icon: Shield, count: 9 },
]

const courses = [
  { id: 1, title: "Full Stack Web Development Bootcamp", provider: "TechHub Academy", price: 150000, rating: 4.9, students: 1234, duration: "12 weeks", location: "Lagos", type: "Hybrid" },
  { id: 2, title: "React & Next.js Masterclass", provider: "Code Academy Nigeria", price: 85000, rating: 4.8, students: 890, duration: "8 weeks", location: "Online", type: "Online" },
  { id: 3, title: "Data Science with Python", provider: "Data School NG", price: 200000, rating: 4.9, students: 750, duration: "16 weeks", location: "Abuja", type: "In-person" },
  { id: 4, title: "Mobile App Development", provider: "AppDev Nigeria", price: 175000, rating: 4.7, students: 620, duration: "14 weeks", location: "Lagos", type: "Hybrid" },
  { id: 5, title: "Cloud Architecture (AWS)", provider: "Cloud Masters", price: 220000, rating: 4.8, students: 430, duration: "10 weeks", location: "Online", type: "Online" },
  { id: 6, title: "Cybersecurity Fundamentals", provider: "SecureTech Academy", price: 180000, rating: 4.6, students: 380, duration: "12 weeks", location: "Lagos", type: "Hybrid" },
]

function DigitalSkillsContent() {
        ...
        <div className="max-w-6xl mx-auto">
            ...
            <div className="flex flex-col sm:flex-row gap-3 sm:gap-4 mb-6 sm:mb-8">
              <div className="relative flex-1">
                ...
                <input
                  ...
                  className="w-full pl-10 sm:pl-12 pr-4 py-2.5 sm:py-3 rounded-xl border border-input bg-white dark:bg-gray-800 text-foreground shadow-lg focus:ring-2 focus:ring-blue-500 focus:outline-none text-sm sm:text-base"
                />
              </div>
          ...
          <ScrollReveal direction="up" delay={100}>
            <p className="text-sm sm:text-base text-muted-foreground mb-4 sm:mb-6">
              Showing {sortedCourses.length} courses in Digital Skills
            </p>
          </ScrollReveal>
                  ...
                  <Card className="h-full border-0 shadow-lg hover:shadow-xl transition-all hover:-translate-y-2 bg-white/80 dark:bg-gray-800/80 backdrop-blur-sm overflow-hidden group">
                    ...
                    <div className="p-4 sm:p-5">
                      ...
                      <div className="flex items-center justify-between">
                        <div>
                          <p className="text-base sm:text-lg font-bold text-blue-600">{formatCurrency(course.price)}</p>
